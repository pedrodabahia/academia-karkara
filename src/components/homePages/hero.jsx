...
export default function Hero(){
    ...
    return(
        <section className="w-full min-h-screen text-center overflow-hidden">
            ...
            className="relative overflow-hidden pt-75 sm:pt-56 lg:pt-80 pb-24 text-white min-h-screen bg-[position:0_40%] bg-no-repeat bg-cover">
            <div className="text-white h-full w-full opacity-30 bg-no-repeat bg-cover absolute z-0 top-0" style={{backgroundImage : "url('/image/backgroundHero.png')"}}></div>
